<!--------------------------------------->
<section class="py-2 bg-primary-gradient">
    <div class="bg-holder" style="background-image:url(assets/home/img/illustrations/footer-bg.png);background-position:center;background-size:cover;">
    </div>
    <!--/.bg-holder-->
...
<!--    JavaScripts-->
<!-- ===============================================-->
<script src="<?php echo base_url() . 'assets/home/public/vendors/@popperjs/popper.min.js' ?>"></script>
<script src="<?php echo base_url() . 'assets/home/public/vendors/bootstrap/bootstrap.min.js' ?>"></script>
<script src="<?php echo base_url() . 'assets/home/public/vendors/is/is.min.js' ?>"></script>
<script src="https://polyfill.io/v3/polyfill.min.js?features=window.scroll"></script>
<script src="<?php echo base_url() . 'assets/home/public/assets/js/theme.js' ?>"></script>
